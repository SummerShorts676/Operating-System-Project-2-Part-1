...
export default function Page() {
  ...
  // Don't render page if user is not valid
  ...
  return (
    <div className="bg-gray-100 text-black py-15">
      {/* Header */}
      <div className="bg-blue-600 p-4 z-100 text-white flex justify-between fixed top-0 left-0 w-full">
      ...
      <div className="mx-auto p-6 flex justify-between">
        <h2 className="text-3xl font-semibold">Hello {user.firstname} {user.lastname}</h2>
          <button
      ...
      {/* Footer */}
      <div className="bg-blue-600 fixed z-100 bottom-0 left-0 w-full p-4 text-white text-center">
